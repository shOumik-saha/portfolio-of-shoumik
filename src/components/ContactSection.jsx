        ...
        <section id="contact" className="py-24 px-4 relative bg-secondary/30">
            <div className="container mx-auto max-w-5xl">
                ...
                <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                    For research correspondence or questions about my work, please contact me by email.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <a 
                                href="mailto:shoumiksahapranto@gmail.com" 
                                className="text-muted-foreground hover:text-primary transition-colors"
                                >
                                    shoumiksahapranto@gmail.com
                                </a>
                                </div>
                            </div>
                            <div className="flex items-start space-x-4">
                        ...
                        <div className="pt-8">
                            ...
                            <div className="flex space-x-4 justify-center">
                                <a href="https://www.linkedin.com/in/shoumiiik/" target="_blank">
                                    <Linkedin />
                                </a>
                                <a href="https://x.com/ShoumikSaha1" target="_blank">
                                    <Twitter />
                                </a>
                                <a href="https://www.instagram.com/shoumiiik_/" target="_blank">
                                    <Instagram />
                                </a>
                                <a href="https://www.facebook.com/shoumik.saha.14" target="_blank">
                                    <Facebook />
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="bg-card p-8 rounded-lg shadow-xs">
                        ...
                        <form
                            action="https://formsubmit.co/shoumiksahapranto@gmail.com"
                            method="POST"
                            className="space-y-6"
                        >
